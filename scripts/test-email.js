...
console.log(
  `   Resend API Key: ${process.env.RESEND_API_KEY ? "✅ Set" : "❌ Missing"}\n`
);
...
const mailOptions = {
  ...
  html: `
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; border-left: 4px solid #28a745;">
        <h2 style="color: #28a745; margin-top: 0;">✅ Resend Email Test</h2>
        <p>Hello!</p>
        <p>This is a test email to verify that your Resend integration is working correctly.</p>
        <p>If you received this email, the migration to Resend was successful! 🎉</p>
  ...
  `,
  text: "This is a test email to verify Resend integration. If you received this, everything is working!",
};
...
try {
  ...
  console.log("   3. Verify sender email in Resend:");
  console.log(`      - Login to https://resend.com`);
  ...
  console.log("   - Verify sender email/domain is configured in Resend");
  ...
  console.error("\n💡 Troubleshooting:");
  console.error("   1. Verify RESEND_API_KEY is correct in .env");
  console.error("   2. Verify sender email is set and verified in Resend");
  console.error("   3. Check Resend account status (not suspended)");
  console.error("   4. Verify sender email/domain is configured correctly in Resend");
  process.exit(1);
}
